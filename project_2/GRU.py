...
import helpers.models as models  # Make sure GRUModel is added to this file
...
def save_results(config, history, best_val_acc, test_acc, conf_matrix, id2label, results_dir):
    model_name = f"gru_h{config['hidden_size']}_l{config['num_layers']}"
...
def main():
    parser = argparse.ArgumentParser(description='Speech Commands Classification with GRU')
    ...
    parser.add_argument('--results_dir', type=str, default='results/gru',
